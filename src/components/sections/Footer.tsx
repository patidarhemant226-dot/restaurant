...
export function Footer() {
  return (
    <footer className="footer">
      ...
      <div className="footer-bottom"><span>© 2026 Mediterra. All rights reserved.</span><span><a href="https://www.instagram.com/" target="_blank" rel="noreferrer">Instagram</a><i>·</i><a href="https://www.facebook.com/" target="_blank" rel="noreferrer">Facebook</a><i>·</i><a href="https://wa.me/912245678900" target="_blank" rel="noreferrer">WhatsApp</a></span></div>
    </footer>
  );
}
